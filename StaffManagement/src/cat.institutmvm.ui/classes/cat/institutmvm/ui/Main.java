...
/*        lNames.removeIf(new Predicate<String>(){
        ...
        System.out.println("\nInfo sobre l'edad dels jugadors");
        System.out.println("--------------------------------------");
        var avg = players.stream().mapToDouble(p -> p.getAge())
                        .average();
        System.out.println("- Mitjana d'edat: "+avg.getAsDouble()+ " anys");
        
        
        var max = players.stream().mapToInt(p -> p.getAge())
                        .max();
        System.out.println("- Maxima edat: "+max.getAsInt()+ " anys");
        ...
        System.out.println("--------------------------------------");
        var avg1 = players.stream().mapToDouble(p -> p.getHeight())
                        .average();
        System.out.println("- Mitjana d'alçada: "+avg1.getAsDouble()+ " m");
        
        
        var max1 = players.stream().mapToDouble(p -> p.getHeight())
                        .max();
        System.out.println("- Maxima alçada: "+max1.getAsDouble()+ " m");
        ...
        System.out.println("--------------------------------------");
        var avg2 = players.stream().mapToDouble(p -> p.getWeight())
                        .average();
        System.out.println("- Mitjana de pes: "+avg2.getAsDouble()+ " Kg");
        
        
        var max2 = players.stream().mapToInt(p -> p.getWeight())
                        .max();
        System.out.println("- Maxim pes: "+max2.getAsInt()+ " Kg");
        
        
        var min2 = players.stream().mapToInt(p -> p.getWeight())
                        .min();
        System.out.println("- Minim pes: "+min2.getAsInt()+ " Kg");
    }
}
