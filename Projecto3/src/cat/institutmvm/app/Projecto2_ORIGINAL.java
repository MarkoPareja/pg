...
Nom del mòdul: PG
 */
public class Projecto2_ORIGINAL {
    ...
    public static void main(String[] args) {
        ...
        String[] arraytipusln = new String[num];
                ...
                if (i == 3) {
                    ...
                    do{
                        ...
                        if(valorCorrecte){
                            ...
                            switch (tipus) {
                                case 0:
                                    arraytipusln[j] = MSG_11;
                                    System.out.println(MSG_11);
                                    exit = true;
                                    break;
                                case 1:
                                    arraytipusln[j] = MSG_12;
                                    System.out.println(MSG_12);
                                    exit = true;
                                    break;
                                case 2:
                                    arraytipusln[j] = MSG_13;
                                    System.out.println(MSG_13);
                                    exit = true;
                                    break;
                                case 3:
                                    arraytipusln[j] = MSG_14;
        ...
        System.out.println("\n" + MSG_7);
            for(j=0; j<arrayint.length; j++){
            System.out.println(arrayid[j] + "\t" + arrayedat[j] + "\t" + arraytipusln[j] + "\t" + arraycompra[j] + "\t" + arraytlf[j]);
        }
        System.out.println("\n" + MSG_16 + num + MSG_17);
